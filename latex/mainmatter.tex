...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/plot_shadow_short_and_policy_interest_rates_euro_area}
    \caption{Shadow short rate (SSR) estimates and policy interest rates in the euro-area}
\end{figure}
