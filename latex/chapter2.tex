...
\end{adjustbox}
\caption{\label{table_1} Replication results of Table 1 Panel A as in \hyperref[item:cieslak_stock_2019]{Cieslak et. al (2019)} using as above specified econometric approach and from FOMC meeting dates generated FOMC dummies using R code matching FOMC Cycle definitions as in \hyperref[item:cieslak_stock_2019]{Cieslak et. al (2019)}.  }
\end{center}
\end{table}
